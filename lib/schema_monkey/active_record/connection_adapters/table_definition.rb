    ...
    module ConnectionAdapters
      module TableDefinition
        ...
        def references_with_schema_monkey(name, options = {})
          Middleware::Migration::Column.start caller: self, operation: :define, table_name: self.name, name: name, type: :reference, options: options.dup do |app, env|
        ...
        def index_with_schema_monkey(column_name, options = {})
          Middleware::Migration::Index.start caller: self, operation: :define, table_name: self.name, column_names: column_name, options: options.dup do |app, env|
